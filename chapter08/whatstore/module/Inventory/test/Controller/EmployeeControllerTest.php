...
class EmployeeControllerTest extends AbstractHttpControllerTestCase
{
    ...
    {
        $this->dispatch('/inventory/employee', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('inventory');
        $this->assertControllerName('employee'); // as specified in router's controller name alias
    ...
    {
        $this->dispatch('/inventory/employee/edit', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('inventory');
        $this->assertControllerName('employee'); // as specified in router's controller name alias
        $this->assertControllerClass('EmployeeController');
