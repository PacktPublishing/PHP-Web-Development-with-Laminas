...
class ResourceControllerTest extends AbstractHttpControllerTestCase
{
    ...
    {
        $this->dispatch('/inventory/resource', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('inventory');
        $this->assertControllerName('resource'); // as specified in router's controller name alias
    ...
    {
        $this->dispatch('/inventory/resource/edit', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('inventory');
        $this->assertControllerName('resource'); // as specified in router's controller name alias
        $this->assertControllerClass('ResourceController');
